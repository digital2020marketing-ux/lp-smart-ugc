...
const stage8_regex = /<h3 className="font-subheading font-heading text-\[clamp\(1\.3rem,2vw,1\.8rem\)\] font-bold text-white mb-4">\s*Studio Validasi:<br \/><span className="grad-text">Visual Debugging & Continuity Check<\/span>\s*<\/h3>[\s\S]*?(?=<\/div>\s*\)\s*},\s*\])/m;
